...
export const projects: Project[] = [
  ...
  {
    id: 'tanush-fitness-b2b',
    number: '06',
    title: 'Tanush Fitness B2B',
    category: 'AI WEBSITES • B2B SAAS • FULL-STACK',
    description: 'An AI-enhanced B2B fitness platform and website engineered for client management, automated booking, and intelligent membership analytics.',
    technologies: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'FastAPI', 'PostgreSQL', 'AI Engine'],
    features: ['AI-driven workout recommendation', 'B2B client portal', 'Automated membership analytics', 'Real-time booking', 'Responsive cyber-luxury UI'],
    metrics: ['45% faster lead qualification', '100% automated booking flow'],
    architecture: ['CLIENT SITE', 'AI ENGINE', 'B2B PORTAL', 'BOOKING WORKFLOW', 'POSTGRESQL'],
    problem: 'B2B fitness providers struggle with fragmented client onboarding, static web design, and manual booking workflows.',
    solution: 'A high-performance AI-powered B2B web platform with automated booking, dynamic lead capture, and intelligent member insights.',
    result: 'A streamlined, modern B2B web application with integrated AI capabilities and 100% automated booking flows.',
    accent: '#00f5d4',
    visual: 'data',
    github: 'https://github.com/D03SOLANKI/tanush_fitness',
  },
];
